package com.projectpharmacy.direction.service

import com.projectpharmacy.api.dto.DocumentDto
import com.projectpharmacy.direction.entity.Direction
import com.projectpharmacy.pharmacy.dto.PharmacyDto
import com.projectpharmacy.pharmacy.service.PharmacySearchService
import spock.lang.Specification

class DirectionServiceTest extends Specification {

    //DirectionService 안에 들어가기 위해서 mock으로 생성함
    ...
    def "buildDirectionList - 정해진 반경 10 km 내에 검색이 되는지 확인"() {
        given:
        pharmacyList.add( //약국 데이터를 하나 추가해서 총 3개가 된다
                PharmacyDto.builder()
                        .id(3L)
                        .pharmacyName("경기약국")
                        .pharmacyAddress("주소3")
